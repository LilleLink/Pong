...
public class PongMenu extends MenuBar {
    ...
    public void fixMenusNewGame() {
        ...
        getItemByText(menuThemes, "Rolf").setDisable(true);
    }
    ...
    public void fixMenusKillGame() {
        ...
        getItemByText(menuThemes, "Rolf").setDisable(false);
    }
    ...
    private Menu createMenuThemes() {
        ...
        RadioMenuItem rolf =  new RadioMenuItem("Rolf");
        cool.setToggleGroup(toggleGroup);
        duckie.setToggleGroup(toggleGroup);
        menuThemes.getItems().addAll(cool, duckie, rolf);
        return menuThemes;
    }
